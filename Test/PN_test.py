...
from setup import reset_seed, pn_prototypical_loss
import time
...
def test_initialize():
    ...
    feature_extractor.load_state_dict(torch.load('Models/P-5.pth'))
...
def test_loop(meta_test_loader, device, feature_extractor, optimizer):
    ...
    for test_task_data, test_task_labels in meta_test_loader:
        ...
        loss, acc, _, predicted_labels, true_labels = pn_prototypical_loss(
